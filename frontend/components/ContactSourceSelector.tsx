...
export default function ContactSourceSelector({ mode, setMode }: { mode: 'scan' | 'manual', setMode: (m: 'scan' | 'manual') => void }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl mb-12">
            ...
            >
                ...
                <div className="text-center relative z-10">
                    ...
                    <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest mt-1">Manual Input</p>
                </div>
